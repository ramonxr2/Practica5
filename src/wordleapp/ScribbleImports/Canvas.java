...
public class Canvas
{
    ...
    public Canvas(String title, int width, int height, Color bgColor)
    {
        ...
        frame.addMouseListener(new MiMouseAdapter(this));
    ...
    public void drawKey(int posX, int posY, int width, int height, Color color,String chara){
    graphic.setColor(Color.BLACK);
    fillRectangle(posX,posY,width,height);
    
    graphic.setColor(color);
    fillRectangle(posX+5,posY+5,width-10,height-10);
    
    graphic.setColor(Color.BLACK);
    graphic.setFont(new Font("Arial", Font.BOLD, 24));
    graphic.drawString(chara, posX+10, posY+25);
